/* Original eight-theme NES score. One eighth-note clock drives both music and cues. */
u8 music_track,beat_flash,beat_no,music_restore;
const u8 tempos[8]={18,12,15,24,12,24,15,15};
const u8 duties[8]={0x40,0x80,0x40,0x80,0x40,0x80,0x80,0x40};
