...
const char* const live_help[3][5]={
 {"ENERGIA ANTES DE REPARAR","LUEGO CAMARA Y MEZCLADORA","ELIGE CUAL ARREGLAR PRIMERO","MEMORIA CIERRA CADA ENLACE","COMPLETA TRES ENLACES"},
 {"CONSIGUE 49 ACIERTOS","NOTA CON COLA: MANTEN","SUELTA AL VACIARSE LA BARRA","LAS OTRAS NOTAS SE PULSAN","PRIMERO PRACTICA CON A"},
 {"ENCUENTRA A DANIEL 3 VECES","MICRO Y GUION SON OPCIONALES","ACERCATE Y PULSA A","DAN PISTAS, PUNTOS Y TIEMPO","B: LUPA   CRUCETA: MOVER"}
};
...
void mission_screen(void){u8 i;
 ...
 center(26,"A / START: COMENZAR");center(28,"B: VOLVER AL MENU");
