...
for script in ['menu_test.py', 'campaign_test.py', 'mmc5_test.py', 'polish_test.py', 'plaza_music_test.py', 'expansion_test.py', 'repair_panel_test.py', 'episode_test.py', 'intro_test.py']:
