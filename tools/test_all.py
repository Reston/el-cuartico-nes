...
for script in ['menu_test.py', 'campaign_test.py', 'mmc5_test.py', 'polish_test.py', 'plaza_music_test.py', 'expansion_test.py', 'repair_panel_test.py', 'episode_test.py', 'intro_test.py', 'presentation_test.py']:
    subprocess.run([sys.executable, str(root / 'tools' / script)], cwd=root, check=True)
if '--mesen' in sys.argv:
    for script in ['campaign_mesen.lua', 'presentation_mesen.lua']:
